...
On remarque que ce problème peut être reformulé comme un problème d'élicitation de préférences en remplaçant les objets $o_i$ par les conséquences possibles du système étudié et en supposant que chaque conséquence est caractérisée par un vecteur d'attributs. 
%Par ailleurs, une technique présentée exige certaines précisions sur des aspects qui ne sont peut-être pas assez claires :
%\begin{itemize}
%\item Comment pourra-t-on trouver un centre d'une région $P$ ?
%\item De laquelle manière doit-on calculer un hyper volume que l'on coupera de $P$ posant telle ou telle paire $(o_i, o_j)$ ?
%\end{itemize}
