...
% projet prospectif pour voir si on arrive à melanger ces deux domaines qui ne sont pas melangés maintenant. Est-ce qu'on arrive à utiliser les techniques de l'élicitation dans le problème de troubleshooting dans l'incertain ? Cela a été proposé comme un projet plus théorique que pratique où on serait censé de faire des essais pour voir si on arrive à améliorer ce qui existe déjà ou inventer des nouvelles techniques qui peuvent être reprises après pour une étude plus approfondie. Pour cela, on était censé de faire ....
% - état de l'art
% - implémentation de ce qui est déjà fait dans le domaine
% - 
